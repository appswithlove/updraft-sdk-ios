...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Raphael Neuenschwander"
  # s.authors            = { "Raphael Neuenschwander" => "neuenschwander.raphael@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Raphael Neuenschwander"
  ...
  s.source       = { :git => "git@git.appswithlove.net:awl_ios/updraft-sdk_ios.git", :tag =>"#{s.version}" }
